...
from aris.config.render_config import RenderConfig
from aris.core.io import build_integrator, build_scene
...
def main(cfg: RenderConfig = None):
    ...
    if cfg.scale > 0:
        ...
        logger.info(f"render at scale {cfg.scale} ({cfg.scene.width}x{cfg.scene.height})")
